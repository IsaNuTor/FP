...
void inicializarChat(tChat &chat, ifstream &archivo, string id_chat)
{
...
{
	// Inicializar chat.
	inicializarChat(chat, archivo, id_chat);
...
// gestionarChat.
bool gestionarChat(tChat &chat, tServidor &servidor, bool &ha_introducido_texto)
{
...
void crearChatConMensaje(tChat &chat, const tMensaje &mensaje)
{
	...
	chat.mensajesChat.arrayMensajes = new tMensaje[MAX_MENSAJES];
	anadirMensajeAlFinalDeLista(chat.mensajesChat, mensaje);
}
